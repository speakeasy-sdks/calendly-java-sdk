...
public class Webhooks {
     ...
     */
    public calendly.calendly.models.operations.PostUsersUuidWebhooksResponse create(calendly.calendly.models.operations.PostUsersUuidWebhooksRequestBody request) throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public calendly.calendly.models.operations.DeleteUsersUserUuidWebhooksWebhookUuidResponse delete(calendly.calendly.models.operations.DeleteUsersUserUuidWebhooksWebhookUuidRequest request) throws Exception {
        String baseUrl = this._serverUrl;
     ...
     * @throws Exception if the API call fails
     */
    public calendly.calendly.models.operations.GetUsersUserUuidWebhooksWebhookUuidResponse get(calendly.calendly.models.operations.GetUsersUserUuidWebhooksWebhookUuidRequest request) throws Exception {
        String baseUrl = this._serverUrl;
     ...
     * @throws Exception if the API call fails
     */
    public calendly.calendly.models.operations.ListWebhooksResponse list(calendly.calendly.models.operations.ListWebhooksRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = calendly.calendly.utils.Utils.generateURL(baseUrl, "/webhook_subscriptions");
        ...
        java.util.List<NameValuePair> queryParams = calendly.calendly.utils.Utils.getQueryParams(calendly.calendly.models.operations.ListWebhooksRequest.class, request, null);
        if (queryParams != null) {
        ...
        calendly.calendly.models.operations.ListWebhooksResponse res = new calendly.calendly.models.operations.ListWebhooksResponse() {{
            listWebhooks200ApplicationJSONObject = null;
            errorResponse = null;
            listWebhooks403ApplicationJSONObject = null;
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
        res.rawResponse = httpRes;
        ...
        if (httpRes.statusCode() == 200) {
            if (calendly.calendly.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                calendly.calendly.models.operations.ListWebhooks200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), calendly.calendly.models.operations.ListWebhooks200ApplicationJSON.class);
            ...
            if (calendly.calendly.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                calendly.calendly.models.operations.ListWebhooksErrorResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), calendly.calendly.models.operations.ListWebhooksErrorResponse.class);
                res.errorResponse = out;
            }
        }
        else if (httpRes.statusCode() == 403) {
            if (calendly.calendly.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                calendly.calendly.models.operations.ListWebhooks403ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), calendly.calendly.models.operations.ListWebhooks403ApplicationJSON.class);
