...
public class Shares {
     ...
     */
    public calendly.calendly.models.operations.PostSharesResponse create(calendly.calendly.models.operations.PostSharesRequestBody request) throws Exception {
