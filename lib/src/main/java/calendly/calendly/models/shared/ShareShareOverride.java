...
public class ShareShareOverride {
    ...
    @JsonProperty("availability_rule")public ShareShareOverrideAvailabilityRule availabilityRule;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("location_configurations")public ShareShareOverrideLocationConfigurations[] locationConfigurations;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("period_type")public ShareShareOverridePeriodTypeEnum periodType;
