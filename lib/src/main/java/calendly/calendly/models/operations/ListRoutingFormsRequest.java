...
public class ListRoutingFormsRequest {
    /**
     * The number of rows to return
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=count")
    public Double count;
    public ListRoutingFormsRequest withCount(Double count) {
        this.count = count;
        return this;
    }
    ...
    public ListRoutingFormsRequest withOrganization(String organization) {
    ...
    public ListRoutingFormsRequest withPageToken(String pageToken) {
    ...
    public String sort;
    public ListRoutingFormsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
