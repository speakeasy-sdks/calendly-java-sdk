...
public class GetScheduledEventsUuid403ApplicationJSON {
    ...
    @JsonProperty("message")public GetScheduledEventsUuid403ApplicationJSONMessageEnum message;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("title")public GetScheduledEventsUuid403ApplicationJSONTitleEnum title;
