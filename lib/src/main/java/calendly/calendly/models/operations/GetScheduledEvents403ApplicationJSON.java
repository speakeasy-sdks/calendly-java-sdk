...
public class GetScheduledEvents403ApplicationJSON {
    ...
    @JsonProperty("message")public GetScheduledEvents403ApplicationJSONMessageEnum message;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("title")public GetScheduledEvents403ApplicationJSONTitleEnum title;
