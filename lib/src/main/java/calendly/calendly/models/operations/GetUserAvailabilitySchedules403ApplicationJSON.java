...
public class GetUserAvailabilitySchedules403ApplicationJSON {
    ...
    @JsonProperty("message")public GetUserAvailabilitySchedules403ApplicationJSONMessageEnum message;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("title")public GetUserAvailabilitySchedules403ApplicationJSONTitleEnum title;
