...
public class PostScheduledEventsUuidCancellationMultipart403ApplicationJSON {
    ...
    @JsonProperty("message")public PostScheduledEventsUuidCancellationMultipart403ApplicationJSONMessageEnum message;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("title")public PostScheduledEventsUuidCancellationMultipart403ApplicationJSONTitleEnum title;
