...
public class GetScheduledEventsEventUuidInviteesInviteeUuidPathParams {
     ...
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=event_uuid")public String eventUuid;
     ...
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=invitee_uuid")public String inviteeUuid;
