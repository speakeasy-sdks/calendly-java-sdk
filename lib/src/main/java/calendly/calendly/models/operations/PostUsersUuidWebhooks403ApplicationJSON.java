...
public class PostUsersUuidWebhooks403ApplicationJSON {
    ...
    @JsonProperty("message")public PostUsersUuidWebhooks403ApplicationJSONMessageEnum message;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("title")public PostUsersUuidWebhooks403ApplicationJSONTitleEnum title;
