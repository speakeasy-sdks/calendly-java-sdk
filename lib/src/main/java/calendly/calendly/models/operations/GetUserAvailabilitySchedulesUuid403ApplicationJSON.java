...
public class GetUserAvailabilitySchedulesUuid403ApplicationJSON {
    ...
    @JsonProperty("message")public GetUserAvailabilitySchedulesUuid403ApplicationJSONMessageEnum message;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("title")public GetUserAvailabilitySchedulesUuid403ApplicationJSONTitleEnum title;
