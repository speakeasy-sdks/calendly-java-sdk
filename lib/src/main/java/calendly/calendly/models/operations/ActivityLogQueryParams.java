...
public class ActivityLogQueryParams {
     ...
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=false,name=action")public String[] action;
     ...
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=false,name=actor")public String[] actor;
     ...
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=max_occurred_at")public OffsetDateTime maxOccurredAt;
     ...
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=min_occurred_at")public OffsetDateTime minOccurredAt;
     ...
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=false,name=namespace")public String[] namespace;
     ...
     * 
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=search_term")public String searchTerm;
     ...
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=false,name=sort")public ActivityLogSortEnum[] sort;
