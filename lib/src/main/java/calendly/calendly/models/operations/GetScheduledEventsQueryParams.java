...
public class GetScheduledEventsQueryParams {
     ...
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=invitee_email")public String inviteeEmail;
     ...
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=max_start_time")public String maxStartTime;
     ...
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=min_start_time")public String minStartTime;
     ...
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=status")public GetScheduledEventsStatusEnum status;
