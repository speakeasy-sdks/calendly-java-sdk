...
public class GetScheduledEventsRequest {
    ...
    public Double count;
    public GetScheduledEventsRequest withCount(Double count) {
        this.count = count;
        return this;
    }
    ...
    public GetScheduledEventsRequest withInviteeEmail(String inviteeEmail) {
    ...
    public GetScheduledEventsRequest withMaxStartTime(String maxStartTime) {
    ...
    public GetScheduledEventsRequest withMinStartTime(String minStartTime) {
    ...
    public GetScheduledEventsRequest withOrganization(String organization) {
    ...
    public GetScheduledEventsRequest withPageToken(String pageToken) {
    ...
    public String sort;
    public GetScheduledEventsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetScheduledEventsRequest withStatus(GetScheduledEventsStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public String user;
    public GetScheduledEventsRequest withUser(String user) {
        this.user = user;
        return this;
    }
