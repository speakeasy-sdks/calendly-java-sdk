...
public class GetEventTypes403ApplicationJSON {
    ...
    @JsonProperty("message")public GetEventTypes403ApplicationJSONMessageEnum message;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("title")public GetEventTypes403ApplicationJSONTitleEnum title;
